...
import SearchComponent from "./AnimatedSearchBar";
    ...
    return(
      ...
      <nav class="navbar p-0 ">
          <div class="container-fluid p-0">
              <div className="Header_Left d-flex justify-content-between">
                  <a className="BlinkitLogo__LogoContainer" href="/">
                  ...
                  <div className="LocationBar_Container">
  
                      <div className="LocationBar_Title">
                          Delivery in 14 minutes</div>
                      <div className="LocationBar_Subtitle">B62, Pocket B, South City I, Sect...
                      </div>
              ...
              <div className="Header_Right">
                  <div className="Profile_btn_container">
                      <button class="btn btn-outline-success Profile_btn" type="submit">Login</button>
                  </div>
                  <div className="Cart_btn_container">
                      <button class="btn btn-outline-success Cart_btn" style={{ fontSize: '13px' }} type="submit">
                          <FontAwesomeIcon icon={faShoppingCart} style={{ marginRight: '10px', fontSize: '20px' }} /> My Cart
                      </button>
                  </div>
      ...
      <nav class="navbar navbar-expand-lg p-0 ">
          <div class="container-fluid Sub-Header">
              <p>Buy vegitables and fruits online</p>
              <ul class="navbar-nav d-flex justify-content-between">
                  <li class="nav-item">
                      <a class="nav-link " aria-current="page" href="#">Vegitables and Fruits</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="#">Coldring and Juice</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#">Instant and Frozzen food</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#">Tea, Coffee and Health Drinks</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#">Bakery and Buscuits</a>
                  </li>
